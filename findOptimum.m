...
[t,y_initial] = ode45(@(t,y) internalIntegration(t,y,dUdr,ddUdrdr,jac_ddUdrdr),tspan,y0,options);
%plot(y(:,1),y(:,2));
...
z0=[0 0 0 0 0 0];
[tau,z] = ode45(@(t,z) externalIntegration(t,z,b,dUdr,ddUdrdr,jac_ddUdrdr,y0,tspan),[0 1],z0,options);

y0_final=y0;
y0_final(7:12)=z(end,:);
[t,y_final] = ode45(@(t,y) internalIntegration(t,y,dUdr,ddUdrdr,jac_ddUdrdr),tspan,y0_final,options);
