...
Vrho0=V0(1)*cos(phi0)+V0(2)*sin(phi0);
Vphi0=(-V0(1)*sin(phi0)+V0(2)*cos(phi0))/rho0;
Vz0=V0(3);
...
%%
px=prpV2pXpVXCylindric(X0,VX0,pr0,pv0);
%px=[0, 0, 0, 0, 0, 0];
pX0=px(1:3)';
pVX0=px(4:6)';
y0 = [X0; VX0; pX0; pVX0];
a_check=[pVX0(1)*cos(phi0)-pVX0(2)*sin(phi0)/rho0; pVX0(1)*sin(phi0)+pVX0(2)*cos(phi0)/rho0; pVX0(3)];
...
[t,y] = ode113(@(t,y) integrateTraectoryCylindric(t,y),tspan/T_unit,y0, options);
